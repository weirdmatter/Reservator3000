...
public class ResourceGen {
	...
	public ResourceGen() {
		...
		this.resources.put(7, new Resource(6, "Room 202", "R649-202", 1, 10.0, "ROOM", 18.0, 10, 10.0));
		
		//Generate physical spaces (auditoriums)
		this.resources.put(8,  new Resource(7,  "Auditorium I",   "A441-506", 1, 45.0, "ROOM", 80.0, 60, 15.0));
		this.resources.put(9,  new Resource(8,  "Auditorium II",  "A441-203", 1, 39.0, "ROOM", 75.0, 40, 15.0));
		this.resources.put(10, new Resource(9,  "Auditorium III", "A441-882", 1, 39.0, "ROOM", 49.0, 50, 15.0));
		this.resources.put(11, new Resource(10, "Auditorium IV",  "A441-405", 1, 28.0, "ROOM", 50.0, 60, 15.0));
		this.resources.put(12, new Resource(11, "Auditorium V",   "A441-240", 1, 40.0, "ROOM", 60.0, 80, 15.0));

		
		//Generate mobile resources (notebooks, smartphones, tablets)
		this.resources.put(13, new Resource(12, "Smartphone Samsung 8GB", "M520-41P", 5, 300.0, "MOBILE_EQUIPMENT", 0.0, 0, 0.0));
		this.resources.put(14, new Resource(13, "Tablet Acer Octa-Core",  "M539-41P", 5, 300.0, "MOBILE_EQUIPMENT", 0.0, 0, 0.0));
		this.resources.put(15, new Resource(14, "Smartphone Samsung 8GB", "M520-41P", 5, 300.0, "MOBILE_EQUIPMENT", 0.0, 0, 0.0));
		this.resources.put(16, new Resource(15, "Smartphone Samsung 8GB", "M520-41P", 5, 300.0, "MOBILE_EQUIPMENT", 0.0, 0, 0.0));
		this.resources.put(17, new Resource(16, "Smartphone Samsung 8GB", "M520-41P", 5, 300.0, "MOBILE_EQUIPMENT", 0.0, 0, 0.0));
		this.resources.put(18, new Resource(17, "Smartphone Samsung 8GB", "M520-41P", 5, 300.0, "MOBILE_EQUIPMENT", 0.0, 0, 0.0));
		this.resources.put(19, new Resource(18, "Smartphone Samsung 8GB", "M520-41P", 5, 300.0, "MOBILE_EQUIPMENT", 0.0, 0, 0.0));
